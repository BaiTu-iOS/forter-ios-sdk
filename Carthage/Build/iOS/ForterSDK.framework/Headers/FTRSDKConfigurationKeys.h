...
// Strings
#define FTR_SDK_CONF_KEY_BASE_API_URL @"BASE_API_URL"
#define FTR_SDK_CONF_KEY_ERROR_REPORTING_API_URL @"ERROR_REPORTING_API_URL"
#define FTR_SDK_CONF_KEY_XRAY_URL @"XRAY_URL"
